...
public class TowerLevelSystem : MonoBehaviour
{
    ...
    public int totalMoneySpent = 0; // �ade hesab� i�in
    ...
    {
        // 1. Spam Kontrol� (Oyun duraklat�lsa bile �al��mas� i�in unscaledTime kulland�k)
    ...
    {
        currentLevel++;
        totalMoneySpent += costSpent; // Harcanan paray� iade havuzuna ekle
